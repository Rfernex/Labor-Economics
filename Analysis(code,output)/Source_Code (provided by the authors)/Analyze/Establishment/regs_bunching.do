...
if inlist("`results_label'", "_check1", "_check2", "_check3", "") {
	graph export "Figures/regs_bunching_DinD`results_label'_aroundPRA.pdf", as(pdf) replace
}
else {
    graph export "Replication/Bunching/C1_Thresholds/regs_bunching_DinD`results_label'_aroundPRA_C1.pdf", as(pdf) replace
}
