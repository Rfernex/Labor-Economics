...
foreach var_to_ave of varlist workweek hourly_earn above*_workweek{
	bysort industry_id: egen `var_to_ave'_prePRA = sum(`var_to_ave'*(year==1933 & month >= 4 & month <= 6)) //Pre-period is April through June
...
save "Data/Generated/industry_SSNRA_analysis_monthly", replace
